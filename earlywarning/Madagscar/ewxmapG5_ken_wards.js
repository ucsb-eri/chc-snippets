...
console.log("dataItemName: ", dataItemName);
        ...
        _this.createMap.call(_this, _this.createLegendx);
...
*/
    ...
    if (this.config.showTimeNav || this.config.showYearControl || this.config.showDekadControl || this.config.showMonthControl) {
      ...
      console.log("this.config.periodicity = ", this.config.periodicity);
      ...
      console.log("this.timeBar 2 = ", this.timeBar);
  ...
  this.calculateDataItemName = function(done) {
    ...
    //createMap();
    if (done) done.call(this, this.createLegendx);
  };
