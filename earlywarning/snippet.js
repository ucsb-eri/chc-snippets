var Snippet = function(configuration) {
...
*/
  ...
  this.loadEwxConfig = function(done) {
    ...
    if (this.config.period == 'latest') {
      ...
      $.ajax({
        ...
        _this.createMap.call(_this);
        //_this.createMap.call(_this, _this.createLegend); //to use createLegend, call from here
  ...
  this.createMap = function(done) {  // not used when using nav buttons
    ...
    const showGaul20080 = this.config.showGaul20080;
    console.log('showGaul20080: ', showGaul20080);
    //var loadBoundary = boundaries.indexOf('gaul_2008_0');

    if (this.config.showGaul20080) {
      console.log('in show  gaul_2008_0');
    ...
    if (this.config.showGaul20081) {
      console.log('in show  gaul_2008_1');
    ...
    if (this.config.showGaul20082) {
      console.log('in show  gaul_2008_2');
    ...
    if (this.config.showKenyaWards) {
      console.log('in show  kenya_wards');
    ...
    console.log("this.config.showTimeNav = ", this.config.showTimeNav);

    if (this.config.showTimeNav || this.config.showYearControl || this.config.showDekadControl || this.config.showMonthControl) {
      console.log("in showTimeNav... ");
  ...
  this.showYearNavigation = function() {
    console.log('in showYearNavigation...');
